                            ...
                            <div className="container mt-12 mx-auto px-4 md:px-0 md:flex md:justify-center md:items-start">
                                ...
                                <div className="md:w-1/2 lg:w-2/3 mt-8 md:mt-0  px-4 py-7 flex flex-col gap-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-2 w-full">
                                            ...
                                            <div className="h-full border-t-3 border-1 p-2 border-gray-400 flex flex-col gap-4 cursor-pointer hover:border-t-red-600 transition-all relative group bg-[#e9e0e0]">
