...
const NewSection = ({ resetQuestions }) => {
    ...
    return (
        <div>
            ...
            <section id="scroll" className="sm:mt-6 lg:mt-8  max-w-fu mx-auto px-4 sm:px-6 lg:px-0">
                <div className="my-10 mx-auto sm:mt-12 sm:px-6  lg:px-0 xl:mt-28 flex flex-col lg:flex-row gap-3">
