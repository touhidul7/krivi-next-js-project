            ...
            <section id="scroll" className="sm:mt-6 lg:mt-8 mt-12 max-w-fu mx-auto px-4 sm:px-6 lg:px-0">
                <div className="my-10 mx-auto sm:mt-12 sm:px-6 md:mt-16 lg:mt-10 lg:px-0  flex flex-col lg:flex-row gap-3">
                    ...
                    <div className="lg:w-full w-full ">
                        ...
                        <p className="text-lg mb-4 font-semibold text-center">Customer-Centric and Data-Driven Marketing:</p>
                            <div className="container mt-12 text-white mx-auto px-4 md:px-0 md:flex md:justify-center md:items-start">
