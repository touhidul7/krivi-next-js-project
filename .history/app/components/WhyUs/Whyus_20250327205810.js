                        ...
                        <div className="bg-[#E7000B] py-20">
                            <div className="container mx-auto px-4 md:px-0 md:flex md:justify-center md:items-start">
                                ...
                                <div className="md:w-1/2 lg:w-1/3 md:mr-8 bg-white p-4">
                                    ...
                                    <p className="text-lg mb-4 font-semibold">Customer-Centric and Data-Driven Marketing:</p>
                                    ...
                                    <Image width={500} height={500} alt="image" src={"../../../public/whyUs.png"} className="mb-7 w-full" />

                                </div>


                                <div className="md:w-1/2 lg:w-2/3 mt-8 md:mt-0 bg-white px-4 py-7 flex flex-col gap-4">
